...
Gem::Specification.new do |spec|
  ...
  if spec.respond_to?(:metadata)
    spec.metadata["allowed_push_host"] = "http://github.com/ikuto0608/resque-queue-status"

    spec.metadata["homepage_uri"] = spec.homepage
    spec.metadata["source_code_uri"] = "http://github.com/ikuto0608/resque-queue-status"
    spec.metadata["changelog_uri"] = "http://github.com/ikuto0608/resque-queue-status"
  else
